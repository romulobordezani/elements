...
var DefaultTheme = function DefaultTheme(theme) {
  ...
  function getMixedColors(paletteName, colorOverride) {
    ...
    return new _index2.default(mixedColors);
  }

  var PrimaryColors = getMixedColors('primary');
  ...
  var SecondaryColors = getMixedColors('secondary');
  ...
  var BlackColors = getMixedColors('black', {
    dark: {
      50: '#858585',
      100: '#5e5e5e',
      200: '#424242',
  ...
  var WhiteColors = getMixedColors('white', {
    dark: {
      50: '#ffffff',
      100: '#ffffff',
      200: '#ffffff',
